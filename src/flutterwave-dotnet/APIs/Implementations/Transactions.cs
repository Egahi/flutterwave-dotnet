...
namespace Flutterwave.Net
{
    public class Transactions : ITransactions
    {
        ...
        /// This is a unique transaction identifier generated by flutterwave systems. 
        /// It is returned in the initiate charge and verify transaction responses as data.id
        /// </param>
        /// <returns>The refund details of the transaction with the specified id</returns>
        public GetRefundDetailsResponse GetRefundDetails(int transactionId)
        {
            return _flutterwaveApi.Get<GetRefundDetailsResponse>(
                $"{Endpoints.REFUNDS}/{transactionId}");
        }
